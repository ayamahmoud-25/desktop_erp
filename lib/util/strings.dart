class Strings{
  //Company page
  static const String Enter_Company_Name ="أدخل اسم الشركة";
  static const String Company_Name ="اسم الشركة";

  //Login user page
  static const String Enter_User_Name ="اسم المستخدم";
  static const String Password ="كلمة السر";


  //Home page
  static const String HOME_TITLE ="الحركات";
  static const String TRANS_STOCK =" الحركات المخزنية";

  static const String TRANS_SHOW ="عرض الحركات";
  static const String TRANS_APPROVED ="موافقات";


  static const String POP_MENU_ITEM_REPORTS ="التقارير";
  static const String POP_MENU_ITEM_SETTINGS ="الاعدادات";
  static const String POP_MENU_ITEM_LOGOUT="تسجيل خروج";
